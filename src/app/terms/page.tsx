        ...
        <div className="space-y-6">
          <section className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-card)] p-5">
            ...
            <p className="leading-relaxed text-zinc-400">
              باستخدامك لمنصة SmmNine، فإنك توافق على جميع الشروط والأحكام المذكورة هنا. يجب قراءة هذه الشروط بعناية قبل إنشاء أي طلب. المنصة مخصصة لتقديم خدمات تنمية الحضور الرقمي بشكل قانوني وآمن.
            </p>
          </section>
