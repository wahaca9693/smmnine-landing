        ...
        <section className="relative overflow-hidden rounded-[2rem] border border-amber-400/30 bg-[#211507] px-5 py-6 shadow-[0_20px_60px_rgba(0,0,0,0.28)] sm:px-8 sm:py-8">
          ...
          <div className="relative flex items-start gap-4">
            ...
            <div className="min-w-0">
              ...
              <h1 className="text-2xl font-black text-amber-50 sm:text-3xl">{t("settings.title")}</h1>
              <p className="mt-2 max-w-2xl text-sm leading-7 text-amber-100/65">{t("settings.subtitle")}</p>
            </div>
          </div>
        </section>
