...
import { Shield, KeyRound, Clock, UserCheck, AlertCircle, Save, CheckCircle2 } from "lucide-react";
            ...
            <div className="space-y-6">
              ...
              {settings.is2faEnabled && (
                <div className="space-y-4 animate-fadeIn">
                  ...
                  <p className="text-[10px] text-zinc-500 leading-4 italic">ملاحظة: الرمز الإفتراضي تم إنشاؤه عند تسجيل حسابك. يمكنك تغييره من قسم تغيير الرمز.</p>
                </div>
              )}
            </div>
